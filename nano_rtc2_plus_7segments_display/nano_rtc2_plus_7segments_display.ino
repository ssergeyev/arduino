...
TM1637 tm1637(2, 3);
  ...
  iarduino_RTC time(RTC_DS1302, 8, 6, 7); // подключаем RTC модуль на базе чипа DS1302, 
  //указывая выводы Arduino подключённые к выводам модуля RST, CLK, DAT
...
void loop(){
    if(millis()%1000==0){ // если прошла 1 секунда
      ...
      int my_time = atoi(time.gettime("Hi"));
      Serial.println(my_time);
      //int my_time = 1225;
      tm1637.dispNumber(my_time);
      tm1637.switchColon();
